import{j as r}from"./index-C0Ga2IoI.js";function d({children:e,className:t="",hover:o=!1,gradient:n=!1,glow:a="blue"}){const i={blue:"hover:shadow-glow",accent:"hover:shadow-glow-accent",none:""};return r.jsxs("div",{className:`
        relative group
