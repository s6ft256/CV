          ...
          <div className="hero__content">
            ...
            <div className="hero__stats">
              ...
              <div className="hero__stat">
                ...
                <span className="hero__stat-label">{t('hero.projectsCompleted')}</span>
              </div>
              <div className="hero__stat">
                <span className="hero__stat-value">IOSH</span>
                <span className="hero__stat-label">{t('hero.certified')}</span>
              </div>
              <div className="hero__stat">
                ...
                <span className="hero__stat-label">{t('hero.nationality')}</span>
              </div>
            </div>
            ...
            <div className="hero__social">
              ...
              {personalInfo.googleDeveloper && (
                <a
                  href={personalInfo.googleDeveloper}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hero__social-link"
