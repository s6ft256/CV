...
export const certifications: Certification[] = [
  ...
  {
    id: '5',
    name: 'Artificial Intelligence (AI) Usage Awareness Training',
    issuer: 'Trojan Construction Holding',
    issueDate: '13 June 2026',
    credentialUrl: assetUrl('Elius_Niwamanya_course_certificate.pdf'),
    category: 'AI & Technology',
  },
  // IT & Cybersecurity
  {
